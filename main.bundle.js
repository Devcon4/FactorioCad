...
var BlueprintStringService = (function () {
...
var deflatePipe = function () { return function (source) {
    return new __WEBPACK_IMPORTED_MODULE_6_rxjs__["Observable"](function (observer) {
        return source.subscribe({
            next: function (x) {
                if (x && x.length > 1) {
                    var subX = (x || '  ').substring(1, x.length);
                    var buffer = __WEBPACK_IMPORTED_MODULE_7_buffer__["Buffer"].from(subX, 'base64');
                    Object(__WEBPACK_IMPORTED_MODULE_8_zlib__["unzip"])(buffer, function (err, buffer) {
                        if (!err) {
...
var BlueprintValidatorDirective = (function () {
...
var BuildComponent = (function () {
    ...
    BuildComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.raw.map(function (i) { return new __WEBPACK_IMPORTED_MODULE_1__tab_list_tab_list_component__["a" /* Item */](i.name, i.path, i.group); }).forEach(function (i) {
...
var EditorComponent = (function () {
    function EditorComponent(http, urlShortenerService, snackBar) {
        this.http = http;
    ...
    EditorComponent.prototype.drawGrid = function () {
        ...
        var rowCount = 20;
        var rowIncrement = 500 / rowCount;
        for (var x = 0; x < this.app.renderer.width; x++) {
            this.grid.moveTo(rowIncrement * x, 0);
            this.grid.lineTo(rowIncrement * x, this.app.renderer.height);
        }
        var columnCount = 20;
        var columnIncrement = 500 / columnCount;
        for (var y = 0; y < this.app.renderer.height; y++) {
    ...
    EditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4__url_shortener_service__["a" /* UrlShortenerService */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["h" /* MatSnackBar */]])
    ], EditorComponent);
...
var MonacoEditorComponent = (function () {
...
var TabListComponent = (function () {
    function TabListComponent(router, route) {
        this.router = router;
        this.route = route;
        this.list = {};
        this.ordinalMap = {};
...
var UrlShortenerService = (function () {
